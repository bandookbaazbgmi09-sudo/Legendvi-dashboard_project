...
TOKEN = '8503195794:AAEYD-t8E4J5_VpJUV-7fyHigDbgfjL-wYM'
OWNER_ID = 6170121198
ADMIN_ID = 6170121198
YOUR_USERNAME = '@LegendOp_77'
UPDATE_CHANNEL = 'https://t.me/botmakertg'
...
def create_main_menu_inline(user_id):
    ...
    buttons = [
        ...
        types.InlineKeyboardButton('📞 Contact Owner', url=f'https://t.me/{YOUR_USERNAME.replace("@LegendOp_77", "")}'),
